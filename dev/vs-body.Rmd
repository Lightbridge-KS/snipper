...
### Fun: Construct Tabstops

```{r create_tabstops}
create_tabstops <- function(locations, 
                            placeholder = NULL, 
                            choices = list(), 
                            variables = NULL
                            ) {
...
create_tabstops(1:2, placeholder = c("A", "B"))
create_tabstops(1, variables = "TM_SELECTED_TEXT")
create_tabstops(1, variables = "TM_SELECTED_TEXT", placeholder = "HI")
```
